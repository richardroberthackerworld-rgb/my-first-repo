...
const VERDICTS = [
  ...
  /* AUXILIARY VARIABLES. Both engines must read the same pairs out of an answer
     that introduces a Pell equation and a fundamental unit — the tuple reader is
     the widest-blast-radius function in either engine, and it was disputing
     correct answers on the strength of their working. */
  ['Find all positive integers x, y with x^2 + y^2 - 5xy = 25',
    '## ✅ Final Answer\n' +
  ...
  /* Each of these separates ONE rule of the tuple reader from the others, so a
     PHP that lost only that rule cannot hide behind the rest.
       ...
       · (k,y) = (187,8) satisfies NO equation anywhere in the answer, so only
         the LABEL rule keeps it out of the claims
       · (25,5) satisfies the question AND k^2-21y^2=100, so only the rule that
         a solution is always a claim keeps it IN */
  ['Find all positive integers x, y with x^2 + y^2 - 5xy = 25',
   '## ✅ Answer\nThe solutions are (1,8), (3,16), (5,25) and their jumps.\n' +
   '\n## 📖 Steps\n1. The Pell equation is k^2-21y^2=100.\n' +
   '2. At n=1 the pair is (k,y) = (187,8), giving x=39 and x=1.'],
  ['Find all positive integers x, y with x^2 + y^2 - 5xy = 25',
   '## ✅ Answer\nBy the Pell equation k^2-21y^2=100 the solutions include (25,5) and (5,25),\n' +
   'together with (1,8), (3,16) and everything the jump generates from them.'],
  ['Find P',               '## ✅ Answer\nP = 4/36 = 1/9'],
  ['Find P',               '## ✅ Answer\nP = 4/36 = 1/8'],
  ['Simplify',             '## ✅ Answer\n2√3/3 + 1/3 = 13/3'],
