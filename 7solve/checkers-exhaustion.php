...
final class Exhaustion
{
    ...
    private const GENERATIVE =
        '/\b(arise[sn]? from|generated by|generates? (?:all|every)|recurrence|and so on|infinitely many|'
      . 'unboundedly many|family of|of the form|iterat\w+|continuing)\b|…|\.\.\./iu';
    ...
    public static function check(string $question, string $md): array
    {
        ...
        if (!preg_match(self::ALL_ASKED_RE, $question)) return $out;
