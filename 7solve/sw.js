...
const CACHE = '7solve-shell-v36';
const SHELL = ['./', './index.html', './assets/logo.svg', './icon-192.png', './icon-512.png'];
...
self.addEventListener('fetch', (e) => {
  ...
  if (url.origin !== self.location.origin) return;  // let AI/hub calls go straight to the network
